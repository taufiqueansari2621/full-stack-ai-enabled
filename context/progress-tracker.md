...
- Reorganized the global sidebar into semantic Learn, Practice, Build, Review, Career, and Help groups from one typed route source; added independent short-viewport scrolling, assistive-technology-safe icons, and browser assertions without changing focused learning or mobile drawer behavior.
